...
feature -- Tests for invoke and assign requests
	...
	test_invoke_and_assign_request_2 is
		...
		do
			...
			assert ("correct argument type", a_const /= Void)
			assert_equal ("correct argument value", 'a', a_const.value)
		end
	...
	test_invoke_and_assign_request_3 is
		...
		do
			...
			a_const ?= last_argument_list.item (1)
			assert ("correct argument 1 type", a_const /= Void)
			assert_equal ("correct argument 1 value", 1.2, a_const.value)
			a_const ?= last_argument_list.item (2)
			assert ("correct argument 2 type", a_const /= Void)
			assert_equal ("correct argument 2 value", {INTEGER_8} 10, a_const.value)
		end
