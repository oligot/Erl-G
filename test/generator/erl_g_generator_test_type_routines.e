...
indexing
	...
	date: "$Date: 2006/03/12 15:19:05 $"
	revision: "$Revision: 1.10 $"

deferred class ERL_G_GENERATOR_TEST_TYPE_ROUTINES
...
feature -- Test generator
	...
	test_base_type_1 is
		...
		do
			t ?= base_type ("HASH_TABLE [ANY, STRING]", universe)
	...
	test_base_type_2 is
		...
		local
			t: ET_GENERIC_CLASS_TYPE
		do
			t ?= base_type ("TUPLE [ANY, STRING]", universe)
			assert_not_equal ("generic type", Void, t)
