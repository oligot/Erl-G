...
feature -- Tests for assign requests
	...
	test_assign_request_1 is
		...
		do
			...
			a_var ?= last_expression
			assert ("correct expression type", a_var /= Void)
		end
	...
	test_assign_request_2 is
		...
		do
			...
			assert ("correct expression type", an_int /= Void)
			assert_equal ("correct expression", 2, an_int.value)
		end
