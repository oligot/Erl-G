...
<xsl:template match="gobodoc:chapter">
	...
	<head>
	    ...
	    <title>Erl-G</title>
	    <link href="/se_styles.css" rel="stylesheet" type="text/css" media="screen"/>
	    <link href="/se_styles_print.css" rel="stylesheet" type="text/css" media="print"/>
	    <link rel="stylesheet" type="text/css" href="/people/leitner/stylesheet/stylesheet.css" />		
	</head>
	<body>
...
<xsl:template match="gobodoc:chapter" mode="footer">
	...
	<tr>
		...
		<td align="right" valign="top">
			<a href="http://se.inf.ethz.ch/people/leitner/erl_g">
